...
### Як отримати або встановити діагональ
...
Перший ренж вибирає потрібні рядки, другий вибирає колонки. Підматриця `sub1` вибирає перетин рядків `1, 2` та колонок `0, 1` включно. Підматриця `sub2` вибирає перетин рядків `1, 2` та колонок `1, 2`. Підматриці мають спільні елементи `6` i `10`.
