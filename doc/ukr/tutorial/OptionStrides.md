...
Приведена діаграма показано як буфер інтерпретується в матрицю. Пунктирами показано як розміщені підматриці в буфері та, відповідно, матриці. Підматриці використовують один буфер, тому спільні елементи збільшились в 20 разів.
